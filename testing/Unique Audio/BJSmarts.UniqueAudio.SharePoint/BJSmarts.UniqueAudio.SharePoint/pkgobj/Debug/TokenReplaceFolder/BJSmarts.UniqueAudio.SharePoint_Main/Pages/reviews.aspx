...
<asp:Content ID="Content10" ContentPlaceHolderId="PlaceHolderMain" runat="server">	
		...
		<td>	
            ...
            <tr>
                <td valign="top" width="70%">
                    <WebPartPages:WebPartZone runat="server" FrameType="TitleBarOnly" ID="LeftHeader" Title="loc:Left Header" />
			        &nbsp;
                </td>
                <td valign="top" width="30%">
                    <WebPartPages:WebPartZone runat="server" FrameType="TitleBarOnly" ID="RightHeader" Title="loc:Right Header" />
			        &nbsp;
                </td>                                
            </tr>
            </table>
		...
		<td>	
            ...
            <tr>
                <td valign="top" width="25%">
                    <WebPartPages:WebPartZone runat="server" FrameType="TitleBarOnly" ID="FirstRow" Title="loc:First Row" />
			        &nbsp;
                </td>
                <td valign="top" width="25%">
                    <WebPartPages:WebPartZone runat="server" FrameType="TitleBarOnly" ID="SecondRow" Title="loc:Second Row" />
			        &nbsp;
                </td>
                <td valign="top" width="25%">
                    <WebPartPages:WebPartZone runat="server" FrameType="TitleBarOnly" ID="ThirdRow" Title="loc:Third Row" />
			        &nbsp;
                </td>
                <td valign="top" width="25%">
                    <WebPartPages:WebPartZone runat="server" FrameType="TitleBarOnly" ID="FourRow" Title="loc:Four Row" />
			        &nbsp;
                </td>                                
            </tr>
            </table>
    ...
    <tr>
		<td>	
            ...
            <tr>
                <td valign="top" width="70%">
                    <WebPartPages:WebPartZone runat="server" FrameType="TitleBarOnly" ID="LeftFooter" Title="loc:Footer Left" />
			        &nbsp;
                </td>
                <td valign="top" width="30%">
                    <WebPartPages:WebPartZone runat="server" FrameType="TitleBarOnly" ID="RightFooter" Title="loc:Footer Right" />
			        &nbsp;
                </td>                                
            </tr>
            </table>
