...
<table width="100%">
			<tr>		
				 <td  width="165px"><asp:label id="labelTitle" runat="server" /></td><td><asp:Label runat="server" ID="lblTitle"></asp:Label></td>
			</tr>		
			<tr>		
			...
			<tr>		
				 <td  width="165px"><asp:label id="labelEditTitle" runat="server" /></td><td><asp:Label runat="server" ID="lblEditTitle"></asp:Label></td>
			</tr>		
			<tr>		
				 <td  width="165px"><asp:label id="labelViewTitle" runat="server" /></td><td><asp:Label runat="server" ID="lblViewTitle"></asp:Label></td>
			</tr>		
			<tr>		
				 <td  width="165px"><asp:label id="labelOrganization" runat="server" /></td><td><asp:Label runat="server" ID="lblOrganization"></asp:Label></td>
			</tr>		
			<tr>		
				 <td  width="165px"><asp:label id="labelDeleted" runat="server" /></td><td><asp:Label runat="server" ID="lblDeleted"></asp:Label></td>
			</tr>		
