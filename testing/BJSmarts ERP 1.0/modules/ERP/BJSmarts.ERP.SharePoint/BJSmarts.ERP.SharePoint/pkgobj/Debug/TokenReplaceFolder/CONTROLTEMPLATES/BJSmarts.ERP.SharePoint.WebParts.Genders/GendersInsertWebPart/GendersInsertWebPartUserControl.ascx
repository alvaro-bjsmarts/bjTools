...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GendersInsertWebPartUserControl.ascx.cs" Inherits="BJSmarts.ERP.SharePoint.WebParts.Genders.GendersInsertWebPart.GendersInsertWebPartUserControl" %>
...
<tr>	
<td colspan="2" width="100%"><div class="listSubTitle">New Gender</div></td>
</tr>
		<tr>		
