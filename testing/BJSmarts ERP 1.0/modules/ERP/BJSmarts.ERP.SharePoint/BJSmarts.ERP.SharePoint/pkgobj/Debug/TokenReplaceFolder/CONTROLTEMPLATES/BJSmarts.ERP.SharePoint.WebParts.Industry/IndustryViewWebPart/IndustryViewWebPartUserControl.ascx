...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IndustryViewWebPartUserControl.ascx.cs" Inherits="BJSmarts.ERP.SharePoint.WebParts.Industry.IndustryViewWebPart.IndustryViewWebPartUserControl" %>
...
<table width="50%">
			<tr>	
				 <td colspan="2" width="100%"><div class="listSubTitle">Industry</div></td>
			</tr>
						<tr>		
