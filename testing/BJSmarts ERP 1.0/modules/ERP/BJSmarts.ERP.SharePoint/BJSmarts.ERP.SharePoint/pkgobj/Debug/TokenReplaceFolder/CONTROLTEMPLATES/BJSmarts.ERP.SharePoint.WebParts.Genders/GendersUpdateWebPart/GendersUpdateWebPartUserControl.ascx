...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GendersUpdateWebPartUserControl.ascx.cs" Inherits="BJSmarts.ERP.SharePoint.WebParts.Genders.GendersUpdateWebPart.GendersUpdateWebPartUserControl" %>
...
<table width="50%">
<tr>	
<td colspan="2" width="100%"><div class="listSubTitle">Gender</div></td>
</tr>
		<tr>		
