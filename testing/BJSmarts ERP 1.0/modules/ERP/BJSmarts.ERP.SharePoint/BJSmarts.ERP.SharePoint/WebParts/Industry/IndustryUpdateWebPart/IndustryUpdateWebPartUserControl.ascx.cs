...
namespace BJSmarts.ERP.SharePoint.WebParts.Industry.IndustryUpdateWebPart
{
    public partial class IndustryUpdateWebPartUserControl : UserControl
    {
        ...
        private void addRecord(SPUser author, SPWeb web, Boolean IsDraft)
        {
            ...
            SPListItemCollection listItems = web.Lists["Industry"].Items;
