...
namespace BJSmarts.ERP.SharePoint.WebParts.Marital.MaritalStatusUpdateWebPart
{
    public partial class MaritalStatusUpdateWebPartUserControl : UserControl
    {
        ...
        private void addRecord(SPUser author, SPWeb web, Boolean IsDraft)
        {
            ...
            SPListItemCollection listItems = web.Lists["Marital Status"].Items;
