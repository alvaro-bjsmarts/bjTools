...
namespace BJSmarts.ERP.SharePoint.WebParts.Marital.MaritalStatusListViewWebPart
{
    public partial class MaritalStatusListViewWebPartUserControl : UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            using (SPSite site = new SPSite(SPContext.Current.Site.Url))
            {
                ...
                {
                    SPList oList = web.Lists["Marital Status"];
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                int intId = Convert.ToInt32(GridView1.DataKeys[GridView1.SelectedIndex]["MaritalStatusId"]);

                Response.Redirect("/Pages/MaritalStatusViewPage.aspx?RecordID=" + intId, false);
                GridView1.DataBind();
            }
            catch (Exception ex)
            {
        ...
        protected void GridView1_EditIndexChanged(object sender, GridViewEditEventArgs e)
        {
            try
            {
                ...
                int intId = Convert.ToInt32(GridView1.DataKeys[GridView1.EditIndex]["MaritalStatusId"]);

                Response.Redirect("/Pages/MaritalStatusUpdatePage.aspx?RecordID=" + intId, false);
                GridView1.DataBind();
            }
            catch (Exception ex)
            {
        ...
        protected void OnRowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                ...
                {
                    int intId = Convert.ToInt32(GridView1.DataKeys[e.Row.DataItemIndex]["MaritalStatusId"]);
        ...
        {
            int intId = Convert.ToInt32(GridView1.DataKeys[e.RowIndex]["MaritalStatusId"]);
