...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MaritalStatusUpdateWebPartUserControl.ascx.cs" Inherits="BJSmarts.ERP.SharePoint.WebParts.Marital.MaritalStatusUpdateWebPart.MaritalStatusUpdateWebPartUserControl" %>
...
<table width="50%">
<tr>	
<td colspan="2" width="100%"><div class="listSubTitle">Marital Status</div></td>
</tr>
		<tr>		
