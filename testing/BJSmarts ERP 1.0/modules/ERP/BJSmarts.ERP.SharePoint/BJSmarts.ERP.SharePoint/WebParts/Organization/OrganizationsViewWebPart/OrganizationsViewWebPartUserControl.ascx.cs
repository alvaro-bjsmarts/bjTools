...
{
    public partial class OrganizationsViewWebPartUserControl : UserControl
    {
                    ...
                    SPSecurity.RunWithElevatedPrivileges(delegate()
                    {
                        using (SPSite site = new SPSite(SPContext.Current.Site.Url))
                        {
                            using (SPWeb web = site.OpenWeb())
                            {
                                ...
                                lblCurrencyId.Text = GetItemTextExternalData("Currency Type", ListItem, "CurrencyId", "Name");

                                lblIndustryId.Text = GetItemTextExternalData("Industry", ListItem, "IndustryId", "Name");
        ...
        protected void b_Click(object sender, EventArgs e)
        {
            if (Page.Request.QueryString["RecordID"] != null)
            {
                Response.Redirect("/Pages/OrganizationsUpdatePage.aspx?RecordId=" + Page.Request.QueryString["RecordID"].ToString());
            }
        }
