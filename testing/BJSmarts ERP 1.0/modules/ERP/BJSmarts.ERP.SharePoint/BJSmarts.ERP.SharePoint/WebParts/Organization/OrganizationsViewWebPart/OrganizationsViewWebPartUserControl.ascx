...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OrganizationsViewWebPartUserControl.ascx.cs" Inherits="BJSmarts.ERP.SharePoint.WebParts.Organization.OrganizationsViewWebPart.OrganizationsViewWebPartUserControl" %>
...
<table width="50%">
			<tr>	
				 <td colspan="2" width="100%"><div class="listSubTitle">Group 1</div></td>
						...
						<tr>		
						 <td  width="165px"><asp:label id="labelCurrencyId" runat="server" /></td><td><asp:Label runat="server" ID="lblCurrencyId"></asp:Label></td>
						</tr>		
						<tr>		
						 <td  width="165px"><asp:label id="labelIndustryId" runat="server" /></td><td><asp:Label runat="server" ID="lblIndustryId"></asp:Label></td>
						</tr>		
