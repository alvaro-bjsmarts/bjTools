...
namespace BJSmarts.ERP.SharePoint.WebParts.Organization.OrganizationsListViewWebPart
{
    public partial class OrganizationsListViewWebPartUserControl : UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            using (SPSite site = new SPSite(SPContext.Current.Site.Url))
            {
                ...
                {
                    SPList oList = web.Lists["Organizations"];
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                int intId = Convert.ToInt32(GridView1.DataKeys[GridView1.SelectedIndex]["OrganizationId"]);

                Response.Redirect("/Pages/OrganizationsViewPage.aspx?RecordID=" + intId, false);
                GridView1.DataBind();
            }
            catch (Exception ex)
            {
        ...
        protected void GridView1_EditIndexChanged(object sender, GridViewEditEventArgs e)
        {
            try
            {
                ...
                int intId = Convert.ToInt32(GridView1.DataKeys[GridView1.EditIndex]["OrganizationId"]);

                Response.Redirect("/Pages/OrganizationsUpdatePage.aspx?RecordID=" + intId, false);
                GridView1.DataBind();
            }
            catch (Exception ex)
            {
        ...
        protected void OnRowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                ...
                {
                    int intId = Convert.ToInt32(GridView1.DataKeys[e.Row.DataItemIndex]["OrganizationId"]);
        ...
        {
            int intId = Convert.ToInt32(GridView1.DataKeys[e.RowIndex]["OrganizationId"]);
