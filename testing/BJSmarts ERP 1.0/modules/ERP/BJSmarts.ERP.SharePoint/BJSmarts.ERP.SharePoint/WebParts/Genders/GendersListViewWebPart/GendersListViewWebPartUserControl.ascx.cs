...
namespace BJSmarts.ERP.SharePoint.WebParts.Genders.GendersListViewWebPart
{
    public partial class GendersListViewWebPartUserControl : UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            using (SPSite site = new SPSite(SPContext.Current.Site.Url))
            {
                ...
                {
                    SPList oList = web.Lists["Genders"];
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                int intId = Convert.ToInt32(GridView1.DataKeys[GridView1.SelectedIndex]["GenderId"]);

                Response.Redirect("/Pages/GendersViewPage.aspx?RecordID=" + intId, false);
                GridView1.DataBind();
            }
            catch (Exception ex)
            {
        ...
        protected void GridView1_EditIndexChanged(object sender, GridViewEditEventArgs e)
        {
            try
            {
                ...
                int intId = Convert.ToInt32(GridView1.DataKeys[GridView1.EditIndex]["GenderId"]);

                Response.Redirect("/Pages/GendersUpdatePage.aspx?RecordID=" + intId, false);
                GridView1.DataBind();
            }
            catch (Exception ex)
            {
        ...
        protected void OnRowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                ...
                {
                    int intId = Convert.ToInt32(GridView1.DataKeys[e.Row.DataItemIndex]["GenderId"]);
        ...
        {
            int intId = Convert.ToInt32(GridView1.DataKeys[e.RowIndex]["GenderId"]);
