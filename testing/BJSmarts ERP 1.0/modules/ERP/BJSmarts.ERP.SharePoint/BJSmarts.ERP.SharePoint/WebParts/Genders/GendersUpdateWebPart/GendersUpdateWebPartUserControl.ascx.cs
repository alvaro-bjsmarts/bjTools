...
namespace BJSmarts.ERP.SharePoint.WebParts.Genders.GendersUpdateWebPart
{
    public partial class GendersUpdateWebPartUserControl : UserControl
    {
        ...
        private void addRecord(SPUser author, SPWeb web, Boolean IsDraft)
        {
            ...
            SPListItemCollection listItems = web.Lists["Genders"].Items;
