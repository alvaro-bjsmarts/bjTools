...
namespace BJSmarts.ERP.SharePoint.WebParts.CountriesUpdateWebPart
{
    public partial class CountriesUpdateWebPartUserControl : UserControl
    {
        ...
        private void addRecord(SPUser author, SPWeb web, Boolean IsDraft)
        {
            ...
            SPListItemCollection listItems = web.Lists["Countries"].Items;
