...
namespace BJSmarts.ERP.SharePoint.WebParts.CountriesListViewWebPart
{
    public partial class CountriesListViewWebPartUserControl : UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            using (SPSite site = new SPSite(SPContext.Current.Site.Url))
            {
                ...
                {
                    SPList oList = web.Lists["Countries"];
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                int intId = Convert.ToInt32(GridView1.DataKeys[GridView1.SelectedIndex]["CountryId"]);

                Response.Redirect("/Pages/CountriesViewPage.aspx?RecordID=" + intId, false);
                GridView1.DataBind();
            }
            catch (Exception ex)
            {
        ...
        protected void GridView1_EditIndexChanged(object sender, GridViewEditEventArgs e)
        {
            try
            {
                ...
                int intId = Convert.ToInt32(GridView1.DataKeys[GridView1.EditIndex]["CountryId"]);

                Response.Redirect("/Pages/CountriesUpdatePage.aspx?RecordID=" + intId, false);
                GridView1.DataBind();
            }
            catch (Exception ex)
            {
        ...
        protected void OnRowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                ...
                {
                    int intId = Convert.ToInt32(GridView1.DataKeys[e.Row.DataItemIndex]["CountryId"]);
        ...
        {
            int intId = Convert.ToInt32(GridView1.DataKeys[e.RowIndex]["CountryId"]);
