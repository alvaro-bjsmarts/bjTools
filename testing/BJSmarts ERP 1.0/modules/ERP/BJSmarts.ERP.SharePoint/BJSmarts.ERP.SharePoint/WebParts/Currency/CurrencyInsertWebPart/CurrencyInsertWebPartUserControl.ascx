...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CurrencyInsertWebPartUserControl.ascx.cs" Inherits="BJSmarts.ERP.SharePoint.WebParts.Currency.CurrencyInsertWebPart.CurrencyInsertWebPartUserControl" %>
