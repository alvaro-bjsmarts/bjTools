...
namespace BJSmarts.ERP.SharePoint.WebParts.Currency.CurrencyUpdateWebPart
{
    public partial class CurrencyUpdateWebPartUserControl : UserControl
    {
        ...
        private void addRecord(SPUser author, SPWeb web, Boolean IsDraft)
        {
            ...
            SPListItemCollection listItems = web.Lists["Currency Type"].Items;
