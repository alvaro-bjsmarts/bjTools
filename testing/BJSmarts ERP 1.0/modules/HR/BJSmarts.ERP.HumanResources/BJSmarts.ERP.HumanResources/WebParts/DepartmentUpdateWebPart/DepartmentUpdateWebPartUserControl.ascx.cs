...
{
    public partial class DepartmentUpdateWebPartUserControl : UserControl
    {
                    ...
                    SPSecurity.RunWithElevatedPrivileges(delegate()
                    {
                        using (SPSite site = new SPSite(SPContext.Current.Site.Url))
                        {
                            using (SPWeb web = site.OpenWeb())
                            {
                                ...
                                txtStreeAddress1.Text = GetItemText(ListItem, "StreeAddress1");
                                txtStreeAddress2.Text = GetItemText(ListItem, "StreeAddress2");
                                txtCity.Text = GetItemText(ListItem, "City");
                                txtState_x002f_Province.Text = GetItemText(ListItem, "State_x002f_Province");
                                txtZip_x002f_PostalCode.Text = GetItemText(ListItem, "Zip_x002f_Postal_x0020_Code");
