...
namespace BJSmarts.ERP.HumanResources.WebParts.ResourceTypeUpdateWebPart
{
    public partial class ResourceTypeUpdateWebPartUserControl : UserControl
    {
        ...
        private void addRecord(SPUser author, SPWeb web, Boolean IsDraft)
        {
            ...
            SPListItemCollection listItems = web.Lists["Resource Types"].Items;
