...
namespace BJSmarts.ERP.HumanResources.WebParts.EmployeeTypesUpdateWebPart
{
    public partial class EmployeeTypesUpdateWebPartUserControl : UserControl
    {
        ...
        private void addRecord(SPUser author, SPWeb web, Boolean IsDraft)
        {
            ...
            SPListItemCollection listItems = web.Lists["Employee Types"].Items;
