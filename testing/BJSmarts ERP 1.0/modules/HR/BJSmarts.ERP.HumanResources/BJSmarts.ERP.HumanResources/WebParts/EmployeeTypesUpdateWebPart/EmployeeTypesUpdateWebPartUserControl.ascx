...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EmployeeTypesUpdateWebPartUserControl.ascx.cs" Inherits="BJSmarts.ERP.HumanResources.WebParts.EmployeeTypesUpdateWebPart.EmployeeTypesUpdateWebPartUserControl" %>
...
<table width="50%">
<tr>	
<td colspan="2" width="100%"><div class="listSubTitle">Employee Types</div></td>
</tr>
		<tr>		
