...
namespace BJSmarts.ERP.HumanResources.WebParts.EmployeeTTListWebPart
{
    public partial class EmployeeTTListWebPartUserControl : UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            using (SPSite site = new SPSite(SPContext.Current.Site.Url))
            {
                ...
                {
                    SPList oList = web.Lists["Employee Termination Type"];
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                int intId = Convert.ToInt32(GridView1.DataKeys[GridView1.SelectedIndex]["EmployeeTerminationTypeId"]);

                Response.Redirect("/Pages/EmployeeTerminationTypeViewPage.aspx?RecordID=" + intId, false);
                GridView1.DataBind();
            }
            catch (Exception ex)
            {
        ...
        protected void GridView1_EditIndexChanged(object sender, GridViewEditEventArgs e)
        {
            try
            {
                ...
                int intId = Convert.ToInt32(GridView1.DataKeys[GridView1.EditIndex]["EmployeeTerminationTypeId"]);

                Response.Redirect("/Pages/EmployeeTerminationTypeUpdatePage.aspx?RecordID=" + intId, false);
                GridView1.DataBind();
            }
            catch (Exception ex)
            {
        ...
        protected void OnRowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                ...
                {
                    int intId = Convert.ToInt32(GridView1.DataKeys[e.Row.DataItemIndex]["EmployeeTerminationTypeId"]);
        ...
        {
            int intId = Convert.ToInt32(GridView1.DataKeys[e.RowIndex]["EmployeeTerminationTypeId"]);
